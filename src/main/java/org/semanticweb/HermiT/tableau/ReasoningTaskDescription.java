...
public class ReasoningTaskDescription {
    ...
    public /* varargs */ ReasoningTaskDescription(boolean flipSatisfiabilityResult, StandardTestType testType, Object ... arguments) {
    ...
    public String getTaskDescription(Prefixes prefixes) {
        String result = this.m_messagePattern;
        for (int argumentIndex = 0; argumentIndex < this.m_arguments.length; ++argumentIndex) {
            Object argument = this.m_arguments[argumentIndex];
            String argumentString = argument instanceof DLPredicate ? ((DLPredicate)argument).toString(prefixes) : (argument instanceof Role ? ((Role)argument).toString(prefixes) : (argument instanceof Concept ? ((Concept)argument).toString(prefixes) : (argument instanceof Term ? ((Term)argument).toString(prefixes) : argument.toString())));
    ...
    public static /* varargs */ ReasoningTaskDescription isConceptSubsumedByList(Object atomicSubconcept, Object ... atomicSuperconcepts) {
    ...
    public static /* varargs */ ReasoningTaskDescription isRoleSubsumedByList(Object subrole, Object ... superroles) {
        StringBuffer message = new StringBuffer();
